...
for g=1:GA.G,
  ...
  if mi<GA.mindis,% fitter than before
    GA.mingen=g;% store
    GA.mindis=mi;
    GA.minX=GA.X(ix,:); % store the selected path or population
...
xlabel('Generations'); ylabel('Shortest distance obtained'); title("30 positions to be visited");
